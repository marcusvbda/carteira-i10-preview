...
const DisconnectedContent = () => {
	return (
		<>
			<Icon icon="/images/theme/b3-color-logo.svg" width="64px" height="56px" />
			<div className="description">
				Conecte sua conta da B3 para ter acesso a todas as suas operações e
				acompanhar o desempenho de suas carteiras.
			</div>
