...
const GoalDialogContent = (): JSX.Element => {
...
export const ModalCreate = (): JSX.Element => {
    return (
        <>
            <Icon
            ...
            <div className="description">
                Metas financeiras servem como um guia para as decisões sobre o
                dinheiro, ajudando a manter o foco e a disciplina, bem como
                permitir que o indivíduo avalie o progresso em relação aos seus
                objetivos. 
            </div>
            <Modal
                size="min(90%,800px)"
...
export const GoalItem = ({ goal }: any): JSX.Element => {
    return (
        <div className="goal-item">
            <div className="item-header">
                <div className="gray-icon">
                    <Icon
                        icon="/images/theme/patrimony-icon.svg"
                        width="16px"
                    />
                </div>
                Total de patrimônio
...
export const GoalList = ({ goals }: any): JSX.Element => {
    return (
...
export default function GoalsCrud(): JSX.Element {
    const goals = useMemo(() => {
        return [
            {
                current: 277000,
