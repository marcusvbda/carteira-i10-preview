...
export const footerRoutes: IFooterRoutes = {
	...
	tools: [
		...
		},
		{
			...
			url: process.env.NEXT_PUBLIC_FOOTER_AGENDA_DIVIDENDOS_FIIS_URL || '#',
		},
		{
		...
		},
		{
			...
			url: process.env.NEXT_PUBLIC_FOOTER_AGENDA_DIVIDENDOS_STOCKS_URL || '#',
		},
		{
			name: 'Agenda de dividendos - Reits',
			url: process.env.NEXT_PUBLIC_FOOTER_AGENDA_DIVIDENDOS_REITS_URL || '#',
		},
		{
			name: 'Agenda de dividendos - BDRs',
			url: process.env.NEXT_PUBLIC_FOOTER_AGENDA_DIVIDENDOS_BDRS_URL || '#',
		},
	],
	courses: [
		{
		...
		},
		{
			...
			url:
				process.env.NEXT_PUBLIC_FOOTER_INTRODUCAO_MERCADO_FINANCEIRO_URL || '#',
		},
		{
			name: 'Curso de Finanças Pessoais',
			url: process.env.NEXT_PUBLIC_FOOTER_CURSO_FINANCAS_PESSOAIS_URL || '#',
		},
		{
			name: 'Ver Todos',
